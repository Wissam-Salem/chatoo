...
export default function Register() {
  ...
  let handleRegister = () => {
    if (username.includes(" ") || email.includes(" ")) {
      setError("Username or email must not contain spaces !");
    } else if (
      username === "" ||
      email === "" ||
      username.length < 3 ||
      ...
      setError("Username or email must be at least 3 charecters !");
      ...
      axios
        .post(
          "http://192.168.0.106:8080/register",
          {
            username,
            email,
            password,
        ...
        .then((res) => {
          res.data.success && window.location.assign("/login");
    ...
    <>
      ...
      {!isLoading && isAuthenticated.data.success === false && (
        <div>
          ...
          />
          <div className="h-[calc(100vh-130px)] max-md:h-[calc(100vh-130px)] flex justify-center items-center">
            <div className="relative py-3 sm:max-w-xl sm:mx-auto">
              <div className="relative px-4 py-10 bg-[#212836] mx-8 md:mx-0 shadow rounded-3xl sm:p-10">
                <div className="max-w-md mx-auto">
                  <div className="flex items-center space-x-5 text-xl text-white justify-center">
                    <h1>Get Started</h1>
                  </div>

                  <div>
                    {error !== null && (
                      <div role="alert" className="alert alert-error relative top-3 flex gap-3">
                        <svg
                  ...
                  <div className="mt-5">
                    ...
                    <input
                      className="border rounded-lg px-3 py-2 mt-1 mb-5 text-white text-sm w-full"
                      type="text"
                      onChange={(e) => {
                  ...
                  <div className="mt-5">
                    <button
                      className="py-2 px-4 btn bg-blue-600 hover:bg-blue-700 text-white w-full transition ease-in duration-200 text-center text-base font-semibold shadow-md focus:outline-none rounded-lg"
                      onClick={() => {
                        handleRegister();
                      }}
                      type="submit"
